...
class SCQBF_Solver(ABC):
    def __init__(self, instance: ScQbfInstance, termination_criteria: TerminationCriteria, debug_options: DebugOptions = DebugOptions()):
        ...
        self._current_solution: ScQbfSolution = None
